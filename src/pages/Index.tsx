...
const Index = () => {
  ...
  return (
    <>
      {/* ═══════════════ HERO SECTION ═══════════════ */}
      <section className={`relative min-h-screen flex items-center overflow-hidden ${layoutMode === "sidebar" ? "pt-10" : "pt-20"} pb-10 sm:pb-0 bg-background`}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            className="absolute inset-0 opacity-[0.8] bg-graph-paper pointer-events-none"
            style={{
              maskImage:
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, transparent 30%, hsl(var(--hero-tint) / 0.7) 100%)",
            }}
          />
          <div
            className="hidden md:block absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full opacity-[0.2] blur-[100px]"
            style={{
              background:
                "radial-gradient(circle, hsl(196 100% 47%), transparent 70%)",
            }}
          />
          <div
            className="hidden md:block absolute top-1/2 left-1/3 w-[400px] h-[400px] rounded-full opacity-[0.15] blur-[80px]"
            style={{
              background:
                "radial-gradient(circle, hsl(215 100% 60%), transparent 70%)",
            }}
          />
        ...
        <div className={`container mx-auto px-4 sm:px-6 grid ${layoutMode === "navbar" ? "lg:grid-cols-2" : "grid-cols-1 md:-mt-20"} gap-8 lg:gap-16 items-center relative z-10`}>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className={`space-y-6 sm:space-y-8 px-4 sm:px-0 text-center ${layoutMode === "navbar" ? "lg:text-left" : "mx-auto w-full"}`}
          >
            <motion.div variants={fadeUp}>
              <span
                className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-xs font-semibold border"
                style={{
                  background: "hsl(250 84% 60% / 0.08)",
                  borderColor: "hsl(250 84% 60% / 0.25)",
                  color: "hsl(250 84% 50%)",
                }}
              >
                <Sparkles size={12} />
            ...
            <motion.div variants={fadeUp}>
              <h1 className="font-heading text-4xl sm:text-[3.2rem] lg:text-[4.2rem] font-extrabold leading-[1.2] tracking-[0.02em] text-foreground transition-all">
                {t("Hii👋🏻,")}{" "}
                <span className="block mt-2">I'm Muhammad Rakha Syamputra</span>
              </h1>
            </motion.div>

            <motion.div variants={fadeUp}>
              <div className={`flex flex-wrap items-center gap-3 justify-center ${layoutMode === "navbar" ? "lg:justify-start" : ""}`}>
                <div
                  className="rounded-full px-3 py-1.5 sm:px-4 sm:py-2 text-[11px] sm:text-xs font-semibold inline-flex items-center gap-2"
                  style={{
            ...
            <motion.p
              variants={fadeUp}
              className={`text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed transition-all ${layoutMode === "navbar" ? "max-w-lg mx-auto lg:mx-0" : "max-w-3xl xl:max-w-4xl mx-auto"}`}
            >
              {t("Hero Description")}
            </motion.p>
            ...
            <motion.div
              variants={fadeUp}
              className={`flex flex-wrap gap-4 pt-2 relative justify-center ${layoutMode === "navbar" ? "lg:justify-start" : ""}`}
            >
              <Link
                to="/projects"
                className="group rounded-full px-5 py-3 sm:px-7 sm:py-3.5 text-[13px] sm:text-sm font-semibold text-white transition-all duration-300 hover:scale-105 shadow-violet inline-flex items-center gap-2"
                style={{
                  background:
            ...
            <motion.div
              variants={fadeUp}
              className={`flex items-center gap-4 pt-2 justify-center ${layoutMode === "navbar" ? "lg:justify-start" : ""}`}
            >
              {[
                {
          ...
          <motion.div
            ...
            className={`hidden ${layoutMode === 'navbar' ? 'lg:flex' : ''} justify-center items-center`}
          >
            <div className="relative" style={{ width: 360, paddingTop: 80 }}>
              <div
                className="absolute inset-x-8 top-24 bottom-0 rounded-[2.5rem] pointer-events-none"
                style={{
                  background:
                    "radial-gradient(ellipse at 50% 40%, hsl(250 84% 60% / 0.12), transparent 70%)",
                  filter: "blur(24px)",
                }}
              />
              <div
              ...
              >
                <div
                  className="absolute top-0 left-12 right-12 h-1 rounded-b-full z-0"
                  style={{
                    background:
                      "linear-gradient(90deg, hsl(250 84% 60%), hsl(196 100% 47%), hsl(344 85% 60%), hsl(37 100% 50%))",
                  }}
                />
                <div
                ...
                <div className="relative z-20 pt-80 pb-6 px-6 text-center">
                  <div
                    className="absolute bottom-0 left-0 right-0 h-36 rounded-b-[2.5rem]"
                    style={{
                      background:
                        "linear-gradient(to top, hsl(var(--card)) 70%, transparent)",
                    }}
                  />
                  <div className="relative z-10">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      IT Project + Product Manager · Software Developer Enthusiast
                    </p>
                    <div
                      className="flex items-center justify-center gap-2 mt-3 rounded-full px-4 py-1.5 mx-auto w-fit"
                      style={{
                        background: "hsl(158 80% 42% / 0.09)",
                        border: "1px solid hsl(158 80% 42% / 0.22)",
                      }}
                    >
                      <span
                        className="w-2 h-2 rounded-full flex-shrink-0"
                        style={{
                          background: "hsl(158 80% 42%)",
                          animation:
